...
# Copy the Soong-generated kernel headers to KERNEL_OBJ/usr at build time
$(TARGET_OUT_INTERMEDIATES)/KERNEL_OBJ/usr:
	@echo "Copying Soong-generated kernel headers to KERNEL_OBJ/usr..."
	mkdir -p $(TARGET_OUT_INTERMEDIATES)/KERNEL_OBJ
	rm -rf $(TARGET_OUT_INTERMEDIATES)/KERNEL_OBJ/usr
	cp -rfL out/soong/.intermediates/vendor/lineage/build/soong/generated_kernel_includes/gen/usr $(TARGET_OUT_INTERMEDIATES)/KERNEL_OBJ/usr
